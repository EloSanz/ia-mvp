    ...
    return (
      <>
        <TableContainer
          sx={{
            width: '100%',
            overflowX: 'auto', // ✅ Permite scroll horizontal solo cuando es necesario
            borderRadius: 2,
        ...
        >
          <Table
            stickyHeader
            sx={{
              minWidth: { xs: 500, sm: 650 }, // ✅ en móviles reducimos el ancho mínimo
              '& th, & td': {
                fontSize: { xs: '0.8rem', sm: '0.875rem' },
                whiteSpace: 'nowrap', // ✅ evita que los textos largos rompan el diseño
              },
            }}
          >
            <TableHead>
              ...
              {/* Segunda fila: filtros y buscador */}
              <TableRow>
                ...
                <TableCell sx={{ py: 0.5, textAlign: 'center' }}>
                  <SettingsIcon sx={{ fontSize: '1.3rem', color: 'text.primary' }} />
                </TableCell>
              </TableRow>
            </TableHead>
